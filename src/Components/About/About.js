...
function About() {
    return (
        <motion.div
            className='portfolio container pt-5 sidebar-gap'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        >
            ...
            <div className="card p-md-5 card-shadow">
                ...
                <div className='text-center px-md-3 pt-3'>
                    <p className='p-2'>Enthusiastic and passionate Front end developer with problem solving skills, and always looking to develop high quality web applications</p>
            ...
            <div className='my-3 d-flex justify-content-center'>
                <Link to='/portfolio'>
                    <button className="btn btn-sm btn-md-md btn-outline-dark rounded-0">PROJECTS</button>
                </Link>
                <Link to='/blogs'>
                    <button className="btn btn-sm btn-outline-dark rounded-0 mx-1">BLOGS</button>
                </Link>
                <Link to='/contact'>
                    <button className="btn btn-sm btn-outline-dark rounded-0">CONTACT</button>
                </Link>
            </div>
        </motion.div>
    )
